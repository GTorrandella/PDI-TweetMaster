...
class test_manager(unittest.TestCase):
    ...
    def testinsertTweets(self):
        ...
        tweetEspecificoRetornado = DataBaseConnector.Connector.returnTweetByIDT("112112")
    ...
    def testInsertCampaign(self):
        ...
        campaignEspecificaRetornada = DataBaseConnector.Connector.retornarCampaignBD(idCampaign)
