...
class test_manager_base(unittest.TestCase):
    ...
    initialCampaigns = [Campaign(1, "a@example.com", '#NothingBreaksLikeAHeart', "", "31 12 2018 23:20:00", "01 01 2019 00:30:00"),
                        Campaign(2, "b@example.com", "", '@POTUS', "31 12 2018 23:20:00", "01 01 2019 00:30:00"),
                        Campaign(3, "c@example.com", '#nintendo-#SMASH', '@Sora_Sakurai-@nintendo', "31 12 2018 23:20:00", "01 01 2019 00:30:00")]
